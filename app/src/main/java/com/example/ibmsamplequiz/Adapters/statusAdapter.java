...
public class statusAdapter extends RecyclerView.Adapter<statusAdapter.ViewHolder> {
    ...
    public statusAdapter(Context context, List<SubmitConfirm> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.status_list_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(option.equals("E"))
        {
            holder.optionTextView.setText("Selected Option: N/A");

        }
        else {
            holder.optionTextView.setText("Option " +question.getSelectedOption()+": "+ optionAnswer );
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            optionTextView = itemView.findViewById(R.id.attemptedText);
            numberTextView = itemView.findViewById(R.id.questionNumber);
            statementTextView = itemView.findViewById(R.id.statementText);
